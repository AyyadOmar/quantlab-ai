...
Existing `public/demo` and `docs/demo` snapshots and website figures are legacy close-to-close results. They have not been refreshed with this protocol. Do not compare their headline metrics directly with v2: labels, execution, costs, selection and benchmark accounting all changed.
